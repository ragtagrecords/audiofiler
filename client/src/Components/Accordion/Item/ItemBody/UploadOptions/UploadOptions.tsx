...
import { addSong, removeExtraExtensions } from 'Services';
import { Song } from 'Types';
import { UploadOptionFields } from 'Components';
...
export const UploadOptions = ({ uploadedFiles, parentSong }: UploadOptionsProps) => {
